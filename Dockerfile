...
RUN composer dump-autoload --optimize \
    && mkdir -p storage/framework/{cache,sessions,views} storage/logs storage/app/public/wallet storage/app/whatsapp-session bootstrap/cache \
    && chown -R www-data:www-data storage bootstrap/cache database

# Install Node.js dependencies for WhatsApp Baileys service
