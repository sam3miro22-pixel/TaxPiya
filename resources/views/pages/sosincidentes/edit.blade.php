            ...
            <div class="row ">
                <div class="col-md-7 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("sosincidentes/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-actor_user_id-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $value = $option->value;
                                                $label = $option->label ?? $value;
                                                $selected = ( $value == $data['actor_user_id'] ? 'selected' : null );
                                            ?>
                                            <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                            <?php echo $label; ?>
                                            </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-descripcion-holder" class=" ">
                                            <textarea placeholder="Escribir Descripcion" id="ctrl-descripcion" data-field="descripcion"  rows="5" name="descripcion" class=" form-control"><?php  echo $data['descripcion']; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-telefono_contacto-holder" class=" ">
                                            <input id="ctrl-telefono_contacto" data-field="telefono_contacto"  value="<?php  echo $data['telefono_contacto']; ?>" type="text" placeholder="Escribir Telefono Contacto"  name="telefono_contacto"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-ubicacion-holder" class=" ">
                                            <input id="ctrl-ubicacion" data-field="ubicacion"  value="<?php  echo $data['ubicacion']; ?>" type="number" placeholder="Escribir Ubicacion" step="any"  name="ubicacion"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-operador_id-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $value = $option->value;
                                                $label = $option->label ?? $value;
                                                $selected = ( $value == $data['operador_id'] ? 'selected' : null );
                                            ?>
                                            <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                            <?php echo $label; ?>
                                            </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nivel_escalamiento-holder" class=" ">
                                            <input id="ctrl-nivel_escalamiento" data-field="nivel_escalamiento"  value="<?php  echo $data['nivel_escalamiento']; ?>" type="number" placeholder="Escribir Nivel Escalamiento" step="any"  name="nivel_escalamiento"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-sla_minutos-holder" class=" ">
                                            <input id="ctrl-sla_minutos" data-field="sla_minutos"  value="<?php  echo $data['sla_minutos']; ?>" type="number" placeholder="Escribir Sla Minutos" step="any"  name="sla_minutos"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-contacto_inicial-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $field_value = $data['contacto_inicial'];
                                                if(!empty($options)){
                                                foreach($options as $option){
                                                $value = $option['value'];
                                                $label = $option['label'];
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-contacto_resultado-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $field_value = $data['contacto_resultado'];
                                                if(!empty($options)){
                                                foreach($options as $option){
                                                $value = $option['value'];
                                                $label = $option['label'];
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-evidencia_url-holder" class=" ">
                                            <input id="ctrl-evidencia_url" data-field="evidencia_url"  value="<?php  echo $data['evidencia_url']; ?>" type="text" placeholder="Escribir Evidencia Url"  name="evidencia_url"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-notas_operacion-holder" class=" ">
                                            <textarea placeholder="Escribir Notas Operacion" id="ctrl-notas_operacion" data-field="notas_operacion"  rows="5" name="notas_operacion" class=" form-control"><?php  echo $data['notas_operacion']; ?></textarea>
                                            <!--<div class="invalid-feedback animated bounceIn text-center">Por favor ingrese el texto</div>-->
                                        </div>
                                    </div>
                                </div>
