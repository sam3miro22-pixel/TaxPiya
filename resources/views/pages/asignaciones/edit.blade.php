            ...
            <div class="row ">
                <div class="col-md-7 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("asignaciones/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-motivo_rechazo-holder" class=" ">
                                            <input id="ctrl-motivo_rechazo" data-field="motivo_rechazo"  value="<?php  echo $data['motivo_rechazo']; ?>" type="text" placeholder="Escribir Motivo Rechazo"  name="motivo_rechazo"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-distancia_m-holder" class=" ">
                                            <input id="ctrl-distancia_m" data-field="distancia_m"  value="<?php  echo $data['distancia_m']; ?>" type="number" placeholder="Escribir Distancia M" step="any"  name="distancia_m"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-eta_min-holder" class=" ">
                                            <input id="ctrl-eta_min" data-field="eta_min"  value="<?php  echo $data['eta_min']; ?>" type="number" placeholder="Escribir Eta Min" step="0.1"  name="eta_min"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-radio_usado_m-holder" class=" ">
                                            <input id="ctrl-radio_usado_m" data-field="radio_usado_m"  value="<?php  echo $data['radio_usado_m']; ?>" type="number" placeholder="Escribir Radio Usado M" step="any"  name="radio_usado_m"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-intento-holder" class=" ">
                                            <input id="ctrl-intento" data-field="intento"  value="<?php  echo $data['intento']; ?>" type="number" placeholder="Escribir Intento" step="any"  required="" name="intento"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-prioridad-holder" class=" ">
                                            <input id="ctrl-prioridad" data-field="prioridad"  value="<?php  echo $data['prioridad']; ?>" type="number" placeholder="Escribir Prioridad" step="any"  required="" name="prioridad"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
