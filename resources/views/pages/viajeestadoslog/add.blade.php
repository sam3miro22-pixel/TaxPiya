            ...
            <div class="row ">
                <div class="col-md-7 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="viajeestadoslog-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('viajeestadoslog.store') }}" method="post">
                            @csrf
                            <div>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-from_estado-holder" class=" ">
                                                ...
                                                <?php
                                                    ...
                                                    $value = $option['value'];
                                                    $label = $option['label'];
                                                    $selected = Html::get_field_selected('from_estado', $value, "");
                                                ?>
                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                <?php echo $label ?>
                                                </option>                                   
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-to_estado-holder" class=" ">
                                                ...
                                                <?php
                                                    ...
                                                    $value = $option['value'];
                                                    $label = $option['label'];
                                                    $selected = Html::get_field_selected('to_estado', $value, "");
                                                ?>
                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                <?php echo $label ?>
                                                </option>                                   
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-actor_id-holder" class=" ">
                                                ...
                                                <?php 
                                                    ...
                                                    $value = $option->value;
                                                    $label = $option->label ?? $value;
                                                    $selected = Html::get_field_selected('actor_id', $value, "");
                                                ?>
                                                <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                                <?php echo $label; ?>
                                                </option>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-motivo_codigo-holder" class=" ">
                                                ...
                                                <?php
                                                    ...
                                                    $value = $option['value'];
                                                    $label = $option['label'];
                                                    $selected = Html::get_field_selected('motivo_codigo', $value, "");
                                                ?>
                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                <?php echo $label ?>
                                                </option>                                   
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-motivo_texto-holder" class=" ">
                                                <input id="ctrl-motivo_texto" data-field="motivo_texto"  value="<?php echo get_value('motivo_texto', "NULL") ?>" type="text" placeholder="Escribir Motivo Texto"  name="motivo_texto"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-app_origen-holder" class=" ">
                                                ...
                                                <?php
                                                    ...
                                                    $value = $option['value'];
                                                    $label = $option['label'];
                                                    $selected = Html::get_field_selected('app_origen', $value, "");
                                                ?>
                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                <?php echo $label ?>
                                                </option>                                   
