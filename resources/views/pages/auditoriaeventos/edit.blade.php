            ...
            <div class="row ">
                <div class="col-md-7 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("auditoriaeventos/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-tabla_objetivo-holder" class=" ">
                                            <input id="ctrl-tabla_objetivo" data-field="tabla_objetivo"  value="<?php  echo $data['tabla_objetivo']; ?>" type="text" placeholder="Escribir Tabla Objetivo"  required="" name="tabla_objetivo"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-registro_pk-holder" class=" ">
                                            <input id="ctrl-registro_pk" data-field="registro_pk"  value="<?php  echo $data['registro_pk']; ?>" type="text" placeholder="Escribir Registro Pk"  required="" name="registro_pk"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-detalles-holder" class=" ">
                                            <input id="ctrl-detalles" data-field="detalles"  value="<?php  echo $data['detalles']; ?>" type="text" placeholder="Escribir Detalles"  name="detalles"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-before_json-holder" class=" ">
                                            <textarea placeholder="Escribir Before Json" id="ctrl-before_json" data-field="before_json"  rows="5" name="before_json" class=" form-control"><?php  echo $data['before_json']; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-after_json-holder" class=" ">
                                            <textarea placeholder="Escribir After Json" id="ctrl-after_json" data-field="after_json"  rows="5" name="after_json" class=" form-control"><?php  echo $data['after_json']; ?></textarea>
                                            <!--<div class="invalid-feedback animated bounceIn text-center">Por favor ingrese el texto</div>-->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-user_agent-holder" class=" ">
                                            <input id="ctrl-user_agent" data-field="user_agent"  value="<?php  echo $data['user_agent']; ?>" type="text" placeholder="Escribir User Agent"  name="user_agent"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-request_id-holder" class=" ">
                                            <input id="ctrl-request_id" data-field="request_id"  value="<?php  echo $data['request_id']; ?>" type="text" placeholder="Escribir Request Id"  name="request_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
