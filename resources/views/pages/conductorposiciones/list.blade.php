...
<?php
    ...
    $can_add = $user->canAccess("conductorposiciones/add");
    $can_edit = $user->canAccess("conductorposiciones/edit");
    $can_view = $user->canAccess("conductorposiciones/view");
    $can_delete = $user->canAccess("conductorposiciones/delete");
    $field_name = request()->segment(3);
    $field_value = request()->segment(4);
    $total_records = $records->total();
    $limit = $records->perPage();
    $record_count = count($records);
    $pageTitle = "Conductor Posiciones"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="py-3 mb-2" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center g-3">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary m-0">Conductor Posiciones</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
                    <a  class="btn btn-primary btn-block" href="<?php print_link("conductorposiciones/add", true) ?>" >
        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="conductorposiciones-list-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/conductorposiciones/", $field_name, $field_value); ?>
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-received_at" > Received At</th>
                                        <th class="td-btn"></th>
                                    </tr>
                                </thead>
                                <?php
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <!--PageComponentStart-->
                                        <td class="td-id">
                                            <a href="<?php print_link("/conductorposiciones/view/$data[id]") ?>"><?php echo $data['id']; ?></a>
                                        </td>
                                ...
                                <td class="td-received_at">
                                    <?php echo  $data['received_at'] ; ?>
                                </td>
                                <!--PageComponentEnd-->
                                <td class="td-btn">
                                    <div class="dropdown" >
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <?php if($can_view){ ?>
                                            <a class="dropdown-item "   href="<?php print_link("conductorposiciones/view/$rec_id"); ?>" >
                                            <i class="fa fa-eye"></i> View
                                        </a>
                                        <?php } ?>
                                        <?php if($can_edit){ ?>
                                        <a class="dropdown-item "   href="<?php print_link("conductorposiciones/edit/$rec_id"); ?>" >
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                    <?php } ?>
                                    <?php if($can_delete){ ?>
                                    <a class="dropdown-item record-delete-btn" data-prompt-msg="¿Seguro que quieres borrar este registro?" data-display-style="modal" href="<?php print_link("conductorposiciones/delete/$rec_id"); ?>" >
    ...
    <div class=" mt-3">
        <div class="row align-items-center justify-content-between">    
            <div class="col-md-auto d-flex gap-2">
                <?php if($can_delete){ ?>
                <button data-prompt-msg="¿Está seguro de que desea eliminar estos registros?" data-display-style="modal" data-url="<?php print_link("conductorposiciones/delete/{sel_ids}"); ?>" class="btn btn-danger btn-delete-selected d-none">
                ...
                <?php Html :: import_form('conductorposiciones/importdata' , "Datos de importacion"); ?>
            </div>
            <div class="col">   
                <?php
