                ...
                <div class="col comp-grid " >
                    <div  class=" page-content" >
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <?php if($can_edit){ ?>
                            <a class="btn btn-success has-tooltip "   title="Editar" href="<?php print_link("conductorposiciones/edit/$rec_id"); ?>" >
                            <i class="fa fa-edit"></i> Edit
                        </a>
                        <?php } ?>
                        <?php if($can_delete){ ?>
                        <a class="btn btn-danger has-tooltip record-delete-btn" data-prompt-msg="¿Seguro que quieres borrar este registro?" data-display-style="modal" title="Borrar" href="<?php print_link("conductorposiciones/delete/$rec_id?redirect=conductorposiciones"); ?>" >
