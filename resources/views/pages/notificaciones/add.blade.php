            ...
            <div class="row ">
                <div class="col-md-7 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="notificaciones-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('notificaciones.store') }}" method="post">
                            @csrf
                            <div>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-canal-holder" class=" ">
                                                ...
                                                <?php
                                                    ...
                                                    $value = $option['value'];
                                                    $label = $option['label'];
                                                    $selected = Html::get_field_selected('canal', $value, "");
                                                ?>
                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                <?php echo $label ?>
                                                </option>                                   
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-proveedor-holder" class=" ">
                                                ...
                                                <?php
                                                    ...
                                                    $value = $option['value'];
                                                    $label = $option['label'];
                                                    $selected = Html::get_field_selected('proveedor', $value, "");
                                                ?>
                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                <?php echo $label ?>
                                                </option>                                   
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-cuerpo-holder" class=" ">
                                                <input id="ctrl-cuerpo" data-field="cuerpo"  value="<?php echo get_value('cuerpo', "NULL") ?>" type="text" placeholder="Escribir Cuerpo"  name="cuerpo"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-data_json-holder" class=" ">
                                                <textarea placeholder="Escribir Data Json" id="ctrl-data_json" data-field="data_json"  rows="5" name="data_json" class=" form-control"><?php echo get_value('data_json') ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-device_token_snapshot-holder" class=" ">
                                                <input id="ctrl-device_token_snapshot" data-field="device_token_snapshot"  value="<?php echo get_value('device_token_snapshot', "NULL") ?>" type="text" placeholder="Escribir Device Token Snapshot"  name="device_token_snapshot"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-provider_message_id-holder" class=" ">
                                                <input id="ctrl-provider_message_id" data-field="provider_message_id"  value="<?php echo get_value('provider_message_id', "NULL") ?>" type="text" placeholder="Escribir Provider Message Id"  name="provider_message_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-error_code-holder" class=" ">
                                                <input id="ctrl-error_code" data-field="error_code"  value="<?php echo get_value('error_code', "NULL") ?>" type="text" placeholder="Escribir Error Code"  name="error_code"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-error_message-holder" class=" ">
                                                <input id="ctrl-error_message" data-field="error_message"  value="<?php echo get_value('error_message', "NULL") ?>" type="text" placeholder="Escribir Error Message"  name="error_message"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-prioridad-holder" class=" ">
                                                ...
                                                <?php
                                                    ...
                                                    $value = $option['value'];
                                                    $label = $option['label'];
                                                    $selected = Html::get_field_selected('prioridad', $value, "");
                                                ?>
                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                <?php echo $label ?>
                                                </option>                                   
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-origen_evento-holder" class=" ">
                                                <input id="ctrl-origen_evento" data-field="origen_evento"  value="<?php echo get_value('origen_evento', "NULL") ?>" type="text" placeholder="Escribir Origen Evento"  name="origen_evento"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
