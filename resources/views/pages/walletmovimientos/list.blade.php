...
<?php
    ...
    $pageTitle = "Movimientos wallet"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="py-3 mb-2" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center g-3">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary m-0">Movimientos wallet</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
                    <a  class="btn btn-primary btn-block" href="<?php print_link("walletmovimientos/add", true) ?>" >
        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="walletmovimientos-list-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/walletmovimientos/", $field_name, $field_value); ?>
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-admin_user_id" > Admin User Id</th>
                                        <th class="td-sentido" > Sentido</th>
                                        <th class="td-motivo" > Motivo</th>
                                        <th class="td-monto" > Monto</th>
                                        <th class="td-moneda" > Moneda</th>
                                        <th class="td-saldo_antes" > Saldo Antes</th>
                                        <th class="td-saldo_despues" > Saldo Despues</th>
                                        <th class="td-descripcion" > Descripcion</th>
                                        <th class="td-referencia_externa" > Referencia Externa</th>
                                        <th class="td-idempotencia" > Idempotencia</th>
                                        <th class="td-anulado" > Anulado</th>
                                        <th class="td-anulado_por" > Anulado Por</th>
                                        <th class="td-anulado_motivo" > Anulado Motivo</th>
                                        <th class="td-anulado_at" > Anulado At</th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <!--PageComponentStart-->
                                        <td class="td-id">
                                            <a href="<?php print_link("/walletmovimientos/view/$data[id]") ?>"><?php echo $data['id']; ?></a>
                                        </td>
                        ...
                        <td class="td-btn">
                            <div class="dropdown" >
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?php if($can_view){ ?>
                                    <a class="dropdown-item "   href="<?php print_link("walletmovimientos/view/$rec_id"); ?>" >
                                    <i class="fa fa-eye"></i> View
                                </a>
                                <?php } ?>
                                <?php if($can_edit){ ?>
                                <a class="dropdown-item "   href="<?php print_link("walletmovimientos/edit/$rec_id"); ?>" >
                                <i class="fa fa-edit"></i> Edit
                            </a>
                            <?php } ?>
                            <?php if($can_delete){ ?>
                            <a class="dropdown-item record-delete-btn" data-prompt-msg="¿Seguro que quieres borrar este registro?" data-display-style="modal" href="<?php print_link("walletmovimientos/delete/$rec_id"); ?>" >
...
<div class=" mt-3">
    <div class="row align-items-center justify-content-between">    
        <div class="col-md-auto d-flex gap-2">
            <?php if($can_delete){ ?>
            <button data-prompt-msg="¿Está seguro de que desea eliminar estos registros?" data-display-style="modal" data-url="<?php print_link("walletmovimientos/delete/{sel_ids}"); ?>" class="btn btn-danger btn-delete-selected d-none">
            ...
            <?php Html :: import_form('walletmovimientos/importdata' , "Datos de importacion"); ?>
        </div>
        <div class="col">   
            <?php
