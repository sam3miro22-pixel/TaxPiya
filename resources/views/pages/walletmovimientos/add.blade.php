            ...
            <div class="row ">
                <div class="col-md-7 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="walletmovimientos-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('walletmovimientos.store') }}" method="post">
                            @csrf
                            <div>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-admin_user_id-holder" class=" ">
                                                ...
                                                <?php 
                                                    ...
                                                    $value = $option->value;
                                                    $label = $option->label ?? $value;
                                                    $selected = Html::get_field_selected('admin_user_id', $value, "");
                                                ?>
                                                <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                                <?php echo $label; ?>
                                                </option>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-sentido-holder" class=" ">
                                                ...
                                                <?php
                                                    ...
                                                    $value = $option['value'];
                                                    $label = $option['label'];
                                                    $selected = Html::get_field_selected('sentido', $value, "");
                                                ?>
                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                <?php echo $label ?>
                                                </option>                                   
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-motivo-holder" class=" ">
                                                ...
                                                <?php
                                                    ...
                                                    $value = $option['value'];
                                                    $label = $option['label'];
                                                    $selected = Html::get_field_selected('motivo', $value, "");
                                                ?>
                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                <?php echo $label ?>
                                                </option>                                   
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-monto-holder" class=" ">
                                                <input id="ctrl-monto" data-field="monto"  value="<?php echo get_value('monto') ?>" type="number" placeholder="Escribir Monto" step="0.1"  required="" name="monto"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-saldo_antes-holder" class=" ">
                                                <input id="ctrl-saldo_antes" data-field="saldo_antes"  value="<?php echo get_value('saldo_antes', "NULL") ?>" type="number" placeholder="Escribir Saldo Antes" step="0.1"  name="saldo_antes"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-saldo_despues-holder" class=" ">
                                                <input id="ctrl-saldo_despues" data-field="saldo_despues"  value="<?php echo get_value('saldo_despues', "NULL") ?>" type="number" placeholder="Escribir Saldo Despues" step="0.1"  name="saldo_despues"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-descripcion-holder" class=" ">
                                                <input id="ctrl-descripcion" data-field="descripcion"  value="<?php echo get_value('descripcion', "NULL") ?>" type="text" placeholder="Escribir Descripcion"  name="descripcion"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-referencia_externa-holder" class=" ">
                                                <input id="ctrl-referencia_externa" data-field="referencia_externa"  value="<?php echo get_value('referencia_externa', "NULL") ?>" type="text" placeholder="Escribir Referencia Externa"  name="referencia_externa"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-anulado-holder" class=" ">
                                                <input id="ctrl-anulado" data-field="anulado"  value="<?php echo get_value('anulado', "0") ?>" type="number" placeholder="Escribir Anulado" step="any"  required="" name="anulado"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-anulado_por-holder" class=" ">
                                                ...
                                                <?php 
                                                    ...
                                                    $value = $option->value;
                                                    $label = $option->label ?? $value;
                                                    $selected = Html::get_field_selected('anulado_por', $value, "");
                                                ?>
                                                <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                                <?php echo $label; ?>
                                                </option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-anulado_motivo-holder" class=" ">
                                                <input id="ctrl-anulado_motivo" data-field="anulado_motivo"  value="<?php echo get_value('anulado_motivo', "NULL") ?>" type="text" placeholder="Escribir Anulado Motivo"  name="anulado_motivo"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
