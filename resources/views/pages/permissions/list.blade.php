    ...
    <div  class="py-3 mb-2" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center g-3">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary m-0">Permissions</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
        ...
        <div class=" mt-3">
            <div class="row align-items-center justify-content-between">    
                <div class="col-md-auto d-flex gap-2">
                    <?php if($can_delete){ ?>
                    <button data-prompt-msg="¿Está seguro de que desea eliminar estos registros?" data-display-style="modal" data-url="<?php print_link("permissions/delete/{sel_ids}"); ?>" class="btn btn-danger btn-delete-selected d-none">
                    ...
                    <?php Html :: import_form('permissions/importdata' , "Datos de importacion"); ?>
                </div>
                <div class="col">   
                    <?php
