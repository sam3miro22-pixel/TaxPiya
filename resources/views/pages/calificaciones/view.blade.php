            ...
            <div class="row ">
                <div class="col comp-grid " >
                    <div  class=" page-content" >
                        ...
                        <div id="page-main-content" class=" mb-3">
                            <div class="page-data">
                                ...
                                <div class="col-12  col-md-4">
                                    <div class="bg-light mb-1 card-1 p-2 border rounded">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <small class="text-muted">Rater Id</small>
                                                <div class="fw-bold">
                                                    <a size="sm" class="btn btn btn-secondary page-modal" href="<?php print_link("users/view/$data[rater_id]?subpage=1") ?>">
                            ...
                            <div class="col-12  col-md-4">
                                <div class="bg-light mb-1 card-1 p-2 border rounded">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <small class="text-muted">Rater Rol</small>
                                            <div class="fw-bold">
                                                <?php echo  $data['rater_rol'] ; ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12  col-md-4">
                                <div class="bg-light mb-1 card-1 p-2 border rounded">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <small class="text-muted">Ratee Id</small>
                                            <div class="fw-bold">
                                                <a size="sm" class="btn btn btn-secondary page-modal" href="<?php print_link("users/view/$data[ratee_id]?subpage=1") ?>">
                                                <i class="fa fa-eye"></i> <?php echo "Users Detail" ?>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12  col-md-4">
                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <small class="text-muted">Ratee Rol</small>
                                        <div class="fw-bold">
                                            <?php echo  $data['ratee_rol'] ; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12  col-md-4">
                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <small class="text-muted">Puntuacion</small>
                                        <div class="fw-bold">
                                            <?php echo  $data['puntuacion'] ; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12  col-md-4">
                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <small class="text-muted">Etiquetas Json</small>
                                        <div class="fw-bold">
                                            <?php echo  $data['etiquetas_json'] ; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <?php if($can_edit){ ?>
                        <a class="btn btn-success has-tooltip "   title="Editar" href="<?php print_link("calificaciones/edit/$rec_id"); ?>" >
                        <i class="fa fa-edit"></i> Edit
                    </a>
                    <?php } ?>
                    <?php if($can_delete){ ?>
                    <a class="btn btn-danger has-tooltip record-delete-btn" data-prompt-msg="¿Seguro que quieres borrar este registro?" data-display-style="modal" title="Borrar" href="<?php print_link("calificaciones/delete/$rec_id?redirect=calificaciones"); ?>" >
