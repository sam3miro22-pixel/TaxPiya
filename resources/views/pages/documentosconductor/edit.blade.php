            ...
            <div class="row ">
                <div class="col-md-7 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("documentosconductor/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-numero-holder" class=" ">
                                            <input id="ctrl-numero" data-field="numero"  value="<?php  echo $data['numero']; ?>" type="text" placeholder="Escribir Numero"  name="numero"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-emisor-holder" class=" ">
                                            <input id="ctrl-emisor" data-field="emisor"  value="<?php  echo $data['emisor']; ?>" type="text" placeholder="Escribir Emisor"  name="emisor"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-archivo_url-holder" class=" ">
                                            <input id="ctrl-archivo_url" data-field="archivo_url"  value="<?php  echo $data['archivo_url']; ?>" type="text" placeholder="Escribir Archivo Url"  name="archivo_url"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-archivo_mime-holder" class=" ">
                                            <input id="ctrl-archivo_mime" data-field="archivo_mime"  value="<?php  echo $data['archivo_mime']; ?>" type="text" placeholder="Escribir Archivo Mime"  name="archivo_mime"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-archivo_size_kb-holder" class=" ">
                                            <input id="ctrl-archivo_size_kb" data-field="archivo_size_kb"  value="<?php  echo $data['archivo_size_kb']; ?>" type="number" placeholder="Escribir Archivo Size Kb" step="any"  name="archivo_size_kb"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-hash_sha256-holder" class=" ">
                                            <input id="ctrl-hash_sha256" data-field="hash_sha256"  value="<?php  echo $data['hash_sha256']; ?>" type="text" placeholder="Escribir Hash Sha256"  name="hash_sha256"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-estado_verificacion-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $field_value = $data['estado_verificacion'];
                                                if(!empty($options)){
                                                foreach($options as $option){
                                                $value = $option['value'];
                                                $label = $option['label'];
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-verificado_por-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $value = $option->value;
                                                $label = $option->label ?? $value;
                                                $selected = ( $value == $data['verificado_por'] ? 'selected' : null );
                                            ?>
                                            <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                            <?php echo $label; ?>
                                            </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-rechazo_motivo-holder" class=" ">
                                            <input id="ctrl-rechazo_motivo" data-field="rechazo_motivo"  value="<?php  echo $data['rechazo_motivo']; ?>" type="text" placeholder="Escribir Rechazo Motivo"  name="rechazo_motivo"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-notas-holder" class=" ">
                                            <textarea placeholder="Escribir Notas" id="ctrl-notas" data-field="notas"  rows="5" name="notas" class=" form-control"><?php  echo $data['notas']; ?></textarea>
