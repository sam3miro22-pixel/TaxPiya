...
<section class="page tax-veh-add-page" data-page-type="edit" data-page-url="{{ url()->full() }}">
    <div class="tax-veh-add-wrap">
        <div class="mb-3">
            <div class="tax-veh-header-row">
                ...
                <div>
                    <div class="tax-veh-title-main">Editar vehículo</div>
                    <div class="tax-veh-title-sub">
                        Actualiza los datos del vehículo y verifica que la información esté al día.
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="tax-veh-card-header">
                <div class="tax-veh-card-header-left">
                    ...
                    <div>
                        ...
                        <div class="tax-veh-title-sub">Revisa y ajusta la información principal del taxi.</div>
                    </div>
                </div>
            </div>

            <form novalidate
                  id="vehiculos-edit-form"
                  role="form"
                  enctype="multipart/form-data"
                  class="tax-veh-card-body form page-form form-horizontal needs-validation"
                  action="<?php print_link("vehiculos/edit/$rec_id"); ?>"
                  method="post">
                @csrf
                ...
                <div class="tax-veh-form-group">
                        ...
                        <select id="ctrl-conductor_id"
                            ...
                            <?php
                                ...
                                foreach($options as $option){
                                    ...
                                    $selected = ($value == $data['conductor_id']) ? 'selected' : '';
                            ?>
                    ...
                    <div class="tax-veh-help">
                        Conductor dueño o responsable operativo de este vehículo.
                    </div>
                </div>
                ...
                <div class="tax-veh-form-group">
                    ...
                    <input id="ctrl-modelo_anio"
                           ...
                           value="<?php echo $data['modelo_anio']; ?>"
                           type="number"
                           placeholder="2022"
                           step="1"
                           name="modelo_anio"
                ...
                <div class="tax-veh-form-group">
                    ...
                    <input id="ctrl-soat_numero"
                           ...
                           value="<?php echo $data['soat_numero']; ?>"
                           type="text"
                ...
                <div class="tax-veh-form-group tax-veh-date-group">
                    ...
                    <div class="input-group">
                        <input id="ctrl-soat_expira"
                               ...
                               value="<?php echo $data['soat_expira']; ?>"
                               type="datetime"
                               name="soat_expira"
                ...
                <div class="tax-veh-form-group tax-veh-date-group">
                    ...
                    <div class="input-group">
                        <input id="ctrl-tecnomecanica_expira"
                               ...
                               class="form-control datepicker tax-veh-form-control"
                               value="<?php echo $data['tecnomecanica_expira']; ?>"
                               type="datetime"
                ...
                <div class="tax-veh-form-group">
                    ...
                    <input id="ctrl-seguro_extracontractual_numero"
                           ...
                           value="<?php echo $data['seguro_extracontractual_numero']; ?>"
                           type="text"
                ...
                <div class="tax-veh-form-group tax-veh-date-group">
                    ...
                    <div class="input-group">
                        <input id="ctrl-seguro_extracontractual_expira"
                               ...
                               class="form-control datepicker tax-veh-form-control"
                               value="<?php echo $data['seguro_extracontractual_expira']; ?>"
                               type="datetime"
                ...
                <div class="tax-veh-form-group">
                    ...
                    <select required
                        ...
                        <?php
                            ...
                            $field_value = $data['estado_vehiculo'];
                            if(!empty($options)){
                                foreach($options as $option){
                                    $value = $option['value'];
                                    $label = $option['label'];
                ...
                <div class="tax-veh-form-group">
                    ...
                    <textarea id="ctrl-verificacion_notas"
                              ...
                              class="form-control tax-veh-form-control"><?php echo $data['verificacion_notas']; ?></textarea>
                </div>

                <input type="hidden"
                       id="ctrl-foto_principal"
                       name="foto_principal"
                       value="<?php echo $data['foto_principal']; ?>">
