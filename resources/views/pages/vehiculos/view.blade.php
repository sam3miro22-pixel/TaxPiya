        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col comp-grid " >
                            ...
                            <div class="row gutter-lg ">
                                <div class="col">
                                    <div class="page-data">
                                        ...
                                        <div class="col-12  col-md-4">
                                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <small class="text-muted">Linea</small>
                                                        <div class="fw-bold">
                                                            <?php echo  $data['linea'] ; ?>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-12  col-md-4">
                                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <small class="text-muted">Modelo Anio</small>
                                                        <div class="fw-bold">
                                        ...
                                        <div class="col-12  col-md-4">
                                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <small class="text-muted">Soat Numero</small>
                                                        <div class="fw-bold">
                                        ...
                                        <div class="col-12  col-md-4">
                                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <small class="text-muted">Soat Expira</small>
                                                        <div class="fw-bold">
                                        ...
                                        <div class="col-12  col-md-4">
                                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <small class="text-muted">Tecnomecanica Expira</small>
                                                        <div class="fw-bold">
                                        ...
                                        <div class="col-12  col-md-4">
                                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <small class="text-muted">Seguro Extracontractual Numero</small>
                                                        <div class="fw-bold">
                                        ...
                                        <div class="col-12  col-md-4">
                                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <small class="text-muted">Seguro Extracontractual Expira</small>
                                                        <div class="fw-bold">
                                        ...
                                        <div class="col-12  col-md-4">
                                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <small class="text-muted">Estado Vehiculo</small>
                                                        <div class="fw-bold">
                                        ...
                                        <div class="col-12  col-md-4">
                                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <small class="text-muted">Verificacion Estado</small>
                                                        <div class="fw-bold">
                                        ...
                                        <div class="col-12  col-md-4">
                                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <small class="text-muted">Verificacion Notas</small>
                                                        <div class="fw-bold">
                                        ...
                                        <div class="col-12  col-md-4">
                                            <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <small class="text-muted">Foto Principal</small>
                                                        <div class="fw-bold">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <?php if($can_edit){ ?>
                                        <a class="btn btn-success has-tooltip "   title="Editar" href="<?php print_link("vehiculos/edit/$rec_id"); ?>" >
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                    <?php } ?>
                                    <?php if($can_delete){ ?>
                                    <a class="btn btn-danger has-tooltip record-delete-btn" data-prompt-msg="¿Seguro que quieres borrar este registro?" data-display-style="modal" title="Borrar" href="<?php print_link("vehiculos/delete/$rec_id?redirect=vehiculos"); ?>" >
                    ...
                    <div class="col-12">
                        <div class="my-3 p-1 ">
                            @include("pages.vehiculos.detail-pages", ["masterRecordId" => $rec_id])
                        </div>
                    </div>
                    <?php } ?>
                </div>
