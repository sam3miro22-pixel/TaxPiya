...
class WalletmovimientosViewExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize
{
	protected $query;
    ...
    {
        $this->query = $query->select(WalletMovimientos::exportViewFields());
        $this->rec_id = $rec_id;
    }
