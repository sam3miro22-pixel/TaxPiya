...
class Uploader
{
	...
	/**
	 * Resizes an image using the Intervention Image package
	 * and saves the thumbnail images to a directory.
	 * 
	 * @method void resizeImage
	 * @param string $file The file path of the image to be resized.
	 * 
	 * @updated 2024-12-05
	 * 
	 * @return void
	...
	private function resizeImage($file)
	{
		if (!empty($this->settings["image_resize"])) {
			...
			foreach ($resizeSettings as $resizeName => $setting) {
				...
				//public folder path to save image
