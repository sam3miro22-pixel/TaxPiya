...
class ConductoresEditRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"user_id" => "filled",
				"estado_operitivo" => "filled|numeric",
				"disponible" => "filled|numeric",
				"last_online_at" => "nullable|date",
				"rating_promedio" => "nullable|numeric",
				"total_viajes" => "filled|numeric",
