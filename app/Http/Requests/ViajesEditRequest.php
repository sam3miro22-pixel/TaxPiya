...
class ViajesEditRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"origen_lat" => "filled|numeric",
				"origen_lng" => "filled|numeric",
				"origen_ubicacion" => "filled|numeric",
				...
				"pago_registrado" => "filled|numeric",
